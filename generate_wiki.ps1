...
$cardsHtml
	...
	(function() {
		...
		const fields = [
			...
			{ group: 'Genel Renkler', label: 'Input Zemini', type: 'color', target: '--bg-input', value: '#fffaf0' },
			...
			{ group: 'Yazilar', label: 'Soluk Metin', type: 'color', target: '--text-low', value: '#9d8754' },
		...
		dynamicStyle.textContent = [
			...
			'.w-cat-btn, .tree-header, .sidebar-footer { color: var(--theme-sidebar-text, #3d2818); }',
